...
RUN rm -f /etc/nginx/sites-enabled/default && \
    ...
    chown -R dimsuser:dimsadm /var/log/nginx && \
    chown -R dimsuser:dimsadm /var/lib/nginx && \
    chown -R dimsuser:dimsadm /data && \
    chown -R dimsuser:dimsadm /run
